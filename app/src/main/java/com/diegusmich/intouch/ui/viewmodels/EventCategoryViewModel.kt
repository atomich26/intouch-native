...
class EventCategoryViewModel : StateViewModel() {
    ...
    fun onLoadEventsByCategory(categoryId: String?, isRefreshing: Boolean = false) = viewModelScope.launch {
        ...
        try {
            _events.value = EventRepository.selectByCategory(categoryId)
