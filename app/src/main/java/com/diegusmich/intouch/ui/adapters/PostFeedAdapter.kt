...
class PostFeedAdapter(private val posts : List<FeedPostPreview>) : RecyclerView.Adapter<PostFeedAdapter.PostFeedViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostFeedViewHolder {
        val itemView =  LayoutInflater.from(parent.context).inflate(R.layout.post_feed_layout, parent, false)
