...
class ArchivedPostsAdapter(collection: List<Post.ArchivePreview>) : DynamicDataAdapter<Post.ArchivePreview, ArchivedPostsAdapter.ArchivedPostViewHolder>(collection) {
